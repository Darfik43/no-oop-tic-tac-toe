// no OOP
// player always makes the move first
// indexing of cols and rows starts with 0..2
...
public class Main {
    ...
    private static String GAME_STATE_O_WON = "O won!";
    private static String GAME_STATE_DRAW = "DRAW!";
    private static String GAME_STATE_NOT_FINISHED = "Game's not finished!";
    ...
    public static int[] inputCellCoordinates(String[][] board) {
        System.out.println("Enter 2 coordinates(row and column) with a space(0-2):");
        // not checking for spaces and digits
        do {
        String[] input = scanner.nextLine().split(" ");
            ...
            if ((row < 0) || (row >= ROW_COUNT) || (col < 0) || (col >= COL_COUNT)) {
                System.out.println("Incorrect value! Enter 2 coordinates(row and column) from 0 to 2 with a space:");
